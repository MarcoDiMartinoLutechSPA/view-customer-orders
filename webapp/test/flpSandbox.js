		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Visualizza Ordini Cliente",
									"targetURL": "#sapbtpviewcustomerorders-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtpviewcustomerorders-display": {
								"semanticObject": "sapbtpviewcustomerorders",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.viewcustomerorders",
									"url": sap.ui.require.toUrl("sap/btp/viewcustomerorders")
								}
							}
						}
					}
